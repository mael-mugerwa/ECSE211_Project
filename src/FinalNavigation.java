...
public class FinalNavigation extends Thread {
  ...
  /**
   * Makes the robot travel to the absolute field location (x, y) This travelTo() doesn't use
   * obstacle detection
   * 
   * @param x - x position that the robot should travel to
   * @param y - y coordinate that the robot should travel to
  ...
  /**
   * Corrects the robot to the correct orientation (parallel to grid line) Returns an array with the
   * required distance offset and actual current odometer values
   */
