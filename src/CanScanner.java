...
S       * @return boolean
  	...
  	public void forwardsSetDistance(double Distance, int speed) {
  		...
  		leftMotor.rotate(Navigation.convertDistance(Project.WHEEL_RAD, Distance), true);
  		rightMotor.rotate(Navigation.convertDistance(Project.WHEEL_RAD, Distance), false);
  	}
